...
if sMessage[0, 1] == "#" 
  ...
  if sCmd == "#kk"
    ...
    SendMessageToPC(oChatter, Kolor("BIALY")+"#dm_obiekt_id {ID} - [DM TOOL #1] nadanie z panelu tekstu wyï¿½wietlanego przez obiekt")
    SendMessageToPC(oChatter, "#dm_obiekt_app {ID} - [DM TOOL #1] nadanie obiektowi wyglï¿½du (wymaga zresetowania lokacji)")
    SendMessageToPC(oChatter, Kolor("BIALY")+"#bn{ID} - [DM TOOL #4] mï¿½wienie oznaczonym NPC")
